...
ActiveRecord::Schema.define(version: 20160511234144) do
  ...
  create_table "sponosored_posts", force: :cascade do |t|
    t.integer  "topic_id"
  ...
  add_index "sponosored_posts", ["topic_id"], name: "index_sponosored_posts_on_topic_id"
